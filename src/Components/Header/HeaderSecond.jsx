...
export default function Header() {
  ...
  const utmContent = queryParams.get('sale/?big_sale') || 'default_big_sale';
  ...
  return (<>
    <div className={styles.header__container}>
      <div className={styles.header}>
        ...
        <span className={styles.phone} href='tel:+7(495)127-05-21'>+7(495)127-05-21</span>
    ...
    <div className={styles.mainСontainer}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.subtitle}>Бесплатная доставка до объекта</div>
